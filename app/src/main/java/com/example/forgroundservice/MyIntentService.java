...
import static com.example.forgroundservice.MyApplication.getMyAppsNotificationManager;
...
public class MyIntentService extends IntentService {
    ...
    private Notification getNotification() {
        return getMyAppsNotificationManager().getNotification(MainActivity.class,
